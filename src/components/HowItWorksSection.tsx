...
const HowItWorksSection = () => {
  const handlePhoneReport = () => {
    alert(
      "Утаснаасаа мэдээлэх хэсэг удахгүй нээгдэнэ! Та гар утаснаасаа саад бэрхшээлийн талаар мэдээлэл илгээх боломжтой болно."
    );
  };

  const handleComputerReport = () => {
    alert(
      "Компьютерээсээ мэдээлэх хэсэг удахгүй нээгдэнэ! Та компьютерээсээ дэлгэрэнгүй мэдээлэл, баримт бичиг нэмэх боломжтой болно."
    );
  };
  ...
  return (
    <section id="how-it-works" className="py-24 px-4 relative overflow-hidden">
      ...
      <div
        className="absolute bottom-20 right-20 w-32 h-32 bg-blue-200 rounded-full blur-3xl opacity-15 animate-pulse"
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-20">
          <Badge
            variant="outline"
            className="mb-6 text-emerald-600 border-emerald-300 bg-emerald-50 px-8 py-3 text-lg font-semibold rounded-full shadow-lg"
          >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Та хүссэн газраасаа, хүссэн цагтаа саад бэрхшээлийн талаар мэдээлж
            болно
          </p>
        </div>
        ...
        {/* Impact Section */}
        <div className="bg-white/90 backdrop-blur-lg rounded-3xl p-5 md:p-12 lg:p-16 max-w-5xl mx-auto shadow-2xl border-2 border-white/20 relative overflow-hidden">
          {/* Background pattern */}
          ...
          <div className="text-center mb-12 relative z-10">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Нэг удаа мэдээлэхийн{" "}
              <span className="text-emerald-600">ач тус</span>
            </h3>
            <p className="text-gray-700 text-xl mb-8 leading-relaxed max-w-3xl mx-auto">
              Та нэг удаа мэдээлэхэд, олон хүн дахин саадтай нүүр тулахгүй байж
              болно.
            </p>
          </div>

          <div className="bg-gradient-to-r from-emerald-50 via-blue-50 to-purple-50 rounded-2xl p-5 sm:p-8 md:p-12 shadow-inner border border-emerald-100 relative z-10">
